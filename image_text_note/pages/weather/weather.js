...
Page({
  data: {
    ...
    // index: [{ title: 'none', }, { title: 'none', }, { title: 'none', }, { title: 'none', }, { title: 'none', }],//建议列表信息 
    index: [{ title: '穿衣', tipt: '穿衣指数', zs: '舒适', des: '建议着长袖T恤、衬衫加单裤等服装。年老体弱者宜着针织长袖衬衫、马甲和长裤。' }, { title: '洗车', tipt: '洗车指数', zs: '不宜', des: '不宜洗车，未来24小时内有雨，如果在此期间洗车，雨水和路上的泥水可能会再次弄脏您的爱车。' }, { title: '感冒', tipt: '感冒指数', zs: '较易发', des: '天气转凉，空气湿度较大，较易发生感冒，体质较弱的朋友请注意适当防护。' }, { title: '运动', tipt: '运动指数', zs: '较不宜', des: '有较强降水，建议您选择在室内进行健身休闲运动。' }, { title: '紫外线强度', tipt: '紫外线强度指数', zs: '最弱', des: '属弱紫外线辐射天气，无需特别防护。若长期在户外，建议涂擦SPF在8-12之间的防晒护肤品。' }]
  },
  onLoad: function() {
    refresh(this);
  },
